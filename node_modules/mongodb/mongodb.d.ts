 ...
 */
// export declare type NestedPaths<Type, Depth extends number[]> = Depth['length'] extends 2 ? [] : Type extends string | number | bigint | boolean | Date | RegExp | Buffer | Uint8Array | ((...args: any[]) => any) | {
//     _bsontype: string;
